...
| 기관 | 내용 |
|---|---|
| 대구디지털혁신진흥원 | 2025년 대구 블록체인 밋업데이 1차 · 2025.08.23 (8시간) — 블록체인 개념부터 간단한 DApp 개발 교육 이수 |
| 영남대학교 첨단AI산업인재양성부트캠프 | 2026학년도 몰입형 AI 부트캠프 · 2026.06.22 ~ 2026.07.10 (45시간) — 생성형 AI 서비스 플랫폼 활용 교육 이수 |
| 데이원컴퍼니 | 2026 경산시 스마트도시 미래인재 육성 프로그램 · 2026.08.03 ~ 2026.08.19 (70시간) — 커리어 치트키반: AI 비즈니스 자동화 실무 과정 교육 이수 예정 |
...
| 활동 | 내용 |
|---|---|
| 점프투게더 | 대학생 교육봉사단 · 지역아동센터 학생 학습 멘토링 및 교육 프로그램 운영 지원 · 2025.09.01 ~ 2025.12.31 (100시간) |
