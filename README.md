...
| 2026.07.13 ~ 2026.11.12 (22시간) | 영남대학교 X 패스트캠퍼스 | 절대 실패하지 않는 무적의 바이브코딩 성공 공식 (w. 100가지 케이스) |
| 2026.07.13 ~ 2026.11.12 (62시간) | 영남대학교 X 패스트캠퍼스 | LLM 모델 개발 Signature |
| 2026.07.13 ~ 2026.11.12 (15시간) | 영남대학교 X 패스트캠퍼스 | 한국형 딥시크 개발자가 알려주는 LLM의 모든 것 : 데이터생성부터 RAG 파인튜닝, 성능 최적화까지 |
| 2026.08.03 ~ 2026.08.19 (70시간) | 데이원컴퍼니 | 2026 경산시 스마트도시 미래인재 육성 프로그램 — 커리어 치트키반: AI 비즈니스 자동화 실무 과정 교육 이수 |
