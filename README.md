...
| 기간 | 소속 / 활동 | 프로젝트 | 역할 |
|---|---|---|---|
| 2024.09 ~ 2024.12 | 영남대 컴퓨터공학과 소프트웨어공학 팀프로젝트 | Let's Study Now — 실시간 스터디 그룹 매칭 서비스 | 프론트엔드 담당 |
| 2025.10 ~ 2026.07 | 경북 연합 공모전 동아리 INNOV | 2026 블레이버스 MVP 개발 해커톤 참여 | 부원 |
| 2026.01.19 ~ 2026.02.13 | 범일정보 현장실습 개인프로젝트 | 통합 협업 + AI 작성 도우미 게시판 | 풀스택 담당 |
| 2026.01.19 ~ 2026.02.13 | 범일정보 현장실습 팀프로젝트 | AudioFallCare — 소리 기반 AI 낙상 감지 시스템 | 백엔드·AI 담당, 팀장 |
| 2026.02.01 ~ 2026.02.10 | 블레이버스 MVP 개발 해커톤 (베스트 팀워크상) | 설스터디 — 멘토·멘티 학습 관리 플랫폼 | 백엔드 담당 |
| 2026.03 ~ 2026.12 | 영남대 컴퓨터공학과 캡스톤 | JinroOn — AI 기반 전공 적합도 탐색 플랫폼 | 프론트엔드 담당 |
...
| 기간 | 기관 | 내용 |
|---|---|---|
| 2025.08.23 (8시간) | 대구디지털혁신진흥원 | 2025년 대구 블록체인 밋업데이 1차 — 블록체인 개념부터 간단한 DApp 개발 교육 이수 |
| 2026.06.22 ~ 2026.07.10 (45시간) | 영남대학교 첨단AI산업인재양성부트캠프 | 2026학년도 몰입형 AI 부트캠프 — 생성형 AI 서비스 플랫폼 활용 교육 이수 |
| 2026.07.13 ~ 2026.11.12 (22시간) | 영남대학교 X 패스트캠퍼스 | 절대 실패하지 않는 무적의 바이브코딩 성공 공식 (w. 100가지 케이스) — 1,000번 이상 해보고 터득한 무조건 이기는 바이브코딩 노하우, 기능 구현부터 문제 해결·수익화까지 |
| 2026.07.13 ~ 2026.11.12 (62시간) | 영남대학교 X 패스트캠퍼스 | LLM 모델 개발 Signature — 파운데이션 LLM을 직접 설계해 사전학습부터 경량화까지 다루는 LLM 개발 과정 |
| 2026.07.13 ~ 2026.11.12 (15시간) | 영남대학교 X 패스트캠퍼스 | 한국형 딥시크 개발자가 알려주는 LLM의 모든 것 : 데이터생성부터 RAG 파인튜닝, 성능 최적화까지 — 한국형 딥시크 개발 실무자의 LLM 활용 강의, 이론부터 4개 실전 프로젝트·논문 리뷰까지 |
| 2026.08.10 ~ 2027.02.05 (972시간) | iM뱅크 | iM DiGital Banker Academy 9기 데이터분석 전문가 양성과정 합격 — 금융데이터 분석 전문 인력 양성과정(K-Digital Training) |
...
| 기간 | 활동 | 내용 |
|---|---|---|
| 2025.09.01 ~ 2025.12.31 (100시간) | 점프투게더 | 대학생 교육봉사단 · 지역아동센터 학생 학습 멘토링 및 교육 프로그램 운영 지원 |
